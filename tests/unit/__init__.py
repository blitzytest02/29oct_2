...
This package contains all unit tests for isolated component testing of
the Flask application. Unit tests focus on testing individual functions,
methods, and classes in isolation with mocked external dependencies.
...
- Mock external dependencies: Database, external APIs, and file systems
  are mocked
